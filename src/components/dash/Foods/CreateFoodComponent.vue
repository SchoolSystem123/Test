<template>
  ...
  >
    ...
    <div class="header">
      {{
        this.$store.state.language == "English"
          ? this.$store.state.English.create_food.page_title
          : this.$store.state.Arabic.create_food.page_title
      }}
    </div>
    <!-- header  -->
    ...
    <div class="form">
      ...
      <label for="title">{{
        this.$store.state.language == "English"
          ? this.$store.state.English.create_food.title
          : this.$store.state.Arabic.create_food.title
      }}</label>
      ...
      <input
        ...
        :placeholder="
          this.$store.state.language == 'English'
            ? this.$store.state.English.create_food.title_placeholder
            : this.$store.state.Arabic.create_food.title_placeholder
        "
      />
      <!-- title  -->
      ...
      <label for="description">{{
        this.$store.state.language == "English"
          ? this.$store.state.English.create_food.description
          : this.$store.state.Arabic.create_food.description
      }}</label>
      ...
      <textarea
        ...
        :placeholder="
          this.$store.state.language == 'English'
            ? this.$store.state.English.create_food.description_placeholder
            : this.$store.state.Arabic.create_food.description_placeholder
        "
      ></textarea>
      <!-- description  -->
      ...
      <button @click="CreateFood">
        {{
          this.$store.state.language == "English"
            ? this.$store.state.English.create_food.button
            : this.$store.state.Arabic.create_food.button
        }}
      </button>
      <!-- button  -->
    </div>
  ...
  methods: {
    ...
    async CreateFood() {
      ...
      if (this.$store.state.user.user_type == "super") {
        // update the api
        this.api = this.$store.state.APIs.food.super.create;
        ...
        // update the api
        this.api = this.$store.state.APIs.food.admin.create;
    ...
    handleFileChange(event) {
      if (event.target.files.length <= 5) {
        ...
        this.$store.state.new_food_images = Array.from(event.target.files);
