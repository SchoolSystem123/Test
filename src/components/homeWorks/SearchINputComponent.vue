    ...
    <p>
      {{
        this.$store.state.language == "English"
          ? this.$store.state.English.home_works_page.search_home_work_title
          : this.$store.state.Arabic.home_works_page.search_home_work_title
      }}
    </p>
    <div class="cont">
      <input
        ...
        :placeholder="
          this.$store.state.language == 'English'
            ? this.$store.state.English.home_works_page.placeholder
            : this.$store.state.Arabic.home_works_page.placeholder
        "
      />
