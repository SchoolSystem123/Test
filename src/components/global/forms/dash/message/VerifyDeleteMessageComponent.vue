<template>
  <div
    :class="`delete-form-${this.$store.state.mood}-${this.$store.state.language}-${this.$store.state.delete_message_form_status}`"
  >
    <div class="header">
      {{
        this.$store.state.language == "English"
          ? this.$store.state.English.delete_messages_form.title
          : this.$store.state.Arabic.delete_messages_form.title
      }}
    </div>
    ...
    <button class="delete" @click="DeleteMessage">
      {{
        this.$store.state.language == "English"
          ? this.$store.state.English.delete_messages_form.delete
          : this.$store.state.Arabic.delete_messages_form.delete
      }}
    </button>
    <button
      class="cancel"
      @click="this.$store.commit('OpenOrCloseDeleteMessage')"
    >
      {{
        this.$store.state.language == "English"
          ? this.$store.state.English.delete_messages_form.cancel
          : this.$store.state.Arabic.delete_messages_form.cancel
      }}
    </button>
  </div>
</template>
      ...
      await axios
        .delete(
          this.$store.state.user.user_type == "super"
            ? this.$store.state.APIs.messages.super.delete
            : this.$store.state.APIs.messages.admin.delete,
          { data, headers }
        )
        .then(() => {
